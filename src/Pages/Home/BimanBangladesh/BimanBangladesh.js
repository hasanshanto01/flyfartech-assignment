...
const BimanBangladesh = () => {
    return (
        <div className='flex flex-col lg:flex-row'>
            <div className='flex flex-col md:flex-row w-full lg:w-4/5 border-b-2 lg:border-b-0 lg:border-r-2 border-dashed'>
                <div className='w-full md:w-1/4 p-5'>
                    ...
                    <p className='text-sm text-secondary text-center md:text-left lg:ml-2 mt-4'><strong>BG 178 | W & BG 671 | E</strong></p>
